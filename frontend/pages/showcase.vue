<template>
    <div class="mx-auto bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 py-10 w-full h-screen">
      <div class="f-center w-full">
        <img src="~/static/logo.svg">
      </div>
      <div class="f-center w-full pb-6 pt-2 text-lg text-black flex-wrap">
        <span class="font-semibold">"Mutlu Müşterilerine"</span> &nbsp; Göz Atarak Başlayın
      </div>
      <div class="f-center">
      ...
      <div class="">
        <div class="f-center w-full absolute bottom-0 pb-2 md:pb-32">
          <nuxt-link :to="'/'">
